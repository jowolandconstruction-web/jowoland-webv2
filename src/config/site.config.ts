...
const siteConfig: SiteConfig = {
  ...
  description:
    'PT. Jowo Land Construction - Kontraktor jasa bore pile & strauss pile profesional sejak 2012. Spesialis geoteknik rekayasa pondasi dengan harga terjangkau, layanan 7 provinsi di Jawa & Bali, dan 98% kepuasan klien.',
  ...
  socialLinks: [
    'https://www.facebook.com/PT.Jowolandconstruction',
    'https://www.instagram.com/pt._jowo_land_construction/',
    'https://www.youtube.com/@JowolandConstruction',
    'https://www.linkedin.com/in/ptjowolandconstruction',
    'https://www.tiktok.com/@jowoland_construction',
    'https://id.pinterest.com/PTJowoLandConstruction/',
    'https://maps.app.goo.gl/ww4J22EsiijZcD6i7',
  ],
  verification: {
